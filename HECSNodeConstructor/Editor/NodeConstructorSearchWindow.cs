...
public class NodeConstructorSearchWindow : ScriptableObject, ISearchWindowProvider
{
    private EditorWindow _window;
    private NodeConstructorGraphView _graphView;
    ...
    private void OnEnable()
    {
        ...
        {
            if (item.IsSubclassOf(typeof(BaseNodeConstruction)) && !item.IsAbstract)
                nodeTypes.Add(item);
        }
    }

    public void Configure(EditorWindow window, NodeConstructorGraphView graphView)
    {
        _window = window;
