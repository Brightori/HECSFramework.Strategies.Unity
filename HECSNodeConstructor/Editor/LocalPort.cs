...
using UnityEngine.UIElements;
    ...
    private readonly DrawConstructorNodeViewGraph drawConstructorNodeViewGraph;

    protected LocalPort(Orientation portOrientation, Direction portDirection, Capacity portCapacity, Type type) : base(portOrientation, portDirection, portCapacity, type)
        {
    }
    ...
    public override void DisconnectAll()
        ...
        public new static LocalPort Create<TEdge>(
        ...
        {
            var listener = new LocalPort.DefaultEdgeConnectorListener();
            var ele = new LocalPort(orientation, direction, capacity, type)
            {
